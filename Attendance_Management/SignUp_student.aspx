<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignUp_student.aspx.cs" Inherits="Attendance_Management.SignUp_student" %>
...
<body>
    <form runat="server">
        <div class="container">
            ...
            <div class="mb-3">
                <asp:TextBox runat="server" ID="dobTextBox" CssClass="form-control" placeholder="Date of Birth as Password" TextMode="Date" Required="true" />
            </div>
            <div class="mb-3">
