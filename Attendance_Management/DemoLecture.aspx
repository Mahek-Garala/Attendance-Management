<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher.Master" AutoEventWireup="true" CodeBehind="DemoLecture.aspx.cs" Inherits="Attendance_Management.DemoLecture" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <div class="form-container">
            ...
            <div class="form-group">
                <label for="txtTotalLecture" class="form-label">Total Lectures:</label>
                    <div>
                        <asp:TextBox ID="txtTotalLecture" runat="server" CssClass="form-dropdown" ReadOnly="true"></asp:TextBox>
        ...
        <br />
        <asp:Button ID="btnSubmit" runat="server" Text="Submit Attendance" OnClick="btnSubmit_Click" CssClass="btn btn-primary" />
    </div>
</asp:Content>
