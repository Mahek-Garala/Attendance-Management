<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignUp_teacher.aspx.cs" Inherits="Attendance_Management.SignUp_teacher" %>
...
<body>
    <form runat="server">
        <div class="container">
            ...
            <p class="mt-3">Already have an account? <a href="Login_teacher.aspx">Login</a></p>
            <p class="mt-3">SignUp as<a href="SignUp_student.aspx">Student</a></p>
        </div>
    </form>
